...
With this method, each measurement interval is completely independent of the others; \ce{CH4} production for each interval is determined from the biogas volume and composition for that interval.
