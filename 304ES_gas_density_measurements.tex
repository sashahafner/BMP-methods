...
Hafner, S.D.; Astals, S.; Holliger, C.; Justesen, C.; Koch, K.; Mortensen, J.R.; Weinrich, S. 2021. Gas density-based BMP measurement. Standard BMP Methods document 304, version 2.2. Available online: https://www.dbfz.de/en/BMP (accessed on \textit{month day year}).
\newline
  En \url{https://www.dbfz.de/en/BMP} encontraréis un documento BibTeX para importarlo al gestor de referencias.
\newline
  Este documento es una traducción al español realizada por Sergi Astals (\texttt{sastals@ub.edu}) y Glen B. Madrigal del documento original en inglés (versión 2.2). En caso de duda el documento en inglés prevalece sobre esta traducción.
}
}
