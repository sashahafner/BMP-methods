...
Measured biogas volume ($V_{biogas,i}$) was 73.6 mL at a temperature ($T_{meas}$) of 30\degree C. Measured headspace pressure ($P_{meas}$) prior to venting was 101.8 kPa (gauge, or 203.1 kPa absolute)
...
\begin{equation*}
   V_{dry} = \frac{73.6\unit{mL} \cdot (203.1\unit{kPa} - 4.237\unit{kPa})}{101.325\unit{kPa}} = 144.5\unit{mL}  
\end{equation*}
...
For method 2 additional calculation of standardized gas volume post venting is required in order to determine interval biogas production. Post-venting pressure in the current ($P_{post_{i}}$) and previous ($P_{post_{i-1}}$) intervals was assumed to be constant atmospheric pressure of 101.325 kPa.  
\begin{equation*}
   V_{dry,post,i-1} = V_{dry,post,i} = \frac{73.6\unit{mL} \cdot (101.325\unit{kPa} - 4.237\unit{kPa})}{101.325\unit{kPa}} = 70.53\unit{mL}  
\end{equation*}
