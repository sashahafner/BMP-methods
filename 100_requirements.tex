...
\label{sec:analysis}
  ...
  \begin{enumerate}
    ...
    \item Volatile solids (VS). Measure for the inoculum and all substrates by combusting the dried sample at 550$^\circ$C in triplicate. VS is determined from mass loss.
  \end{enumerate}
