...
\begin{enumerate}
  ...
  \item Duration. 
    Terminate BMP tests only after daily \ce{CH4} production from individual batches (bottles) during 3 consecutive days is $<$ 1.0\% of the net accumulated volume of methane from the substrate (substrate minus average of blanks). 
